...
slug: astro-paper-v3
featured: false
ogImage: https://github.com/CelestoAI/paper-blog/assets/53733092/1ef0cf03-8137-4d67-ac81-84a032119e3a
tags:
  - release
...
<video autoplay loop="loop" muted="muted" plays-inline="true">
  <source src="https://github.com/CelestoAI/paper-blog/assets/53733092/18fdb604-1ca3-41a0-8372-1367759091ff" type="video/mp4">
...
<video autoplay loop="loop" muted="muted" plays-inline="true">
  <source src="https://github.com/CelestoAI/paper-blog/assets/53733092/3ab5a1e8-1891-4264-a5bb-0ded69143c1a" type="video/mp4">
</video>

**_AstroPaper v3 theme switch_**

<video autoplay loop="loop" muted="muted" plays-inline="true">
  <source src="https://github.com/CelestoAI/paper-blog/assets/53733092/8ac9deb8-d1f8-4029-86bd-6aa0def380b4" type="video/mp4">
</video>
...
Ready to explore the exciting new features and improvements in AstroPaper v3? Start [using AstroPaper](https://github.com/CelestoAI/paper-blog) now.

For other bug fixes and integration updates, check out the [release notes](https://github.com/CelestoAI/paper-blog/releases/tag/v3.0.0) to learn more.

If you encounter any bugs or face difficulties during the upgrade process, please feel free to open an issue or start a discussion on [GitHub](https://github.com/CelestoAI/paper-blog).
